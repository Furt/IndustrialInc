...
public class DesignMiningMachine extends GenericCubeBlockDesign {
	public DesignMiningMachine(IndustrialInc plugin, Texture texture) {
		super(plugin, texture, 6);
		setRenderPass(0);
	    ...
	    Quad side1 = new Quad(1, texture.getSubTexture(1));
	    ...
	    Quad side2 = new Quad(2, texture.getSubTexture(2));
	    ...
	    Quad side3 = new Quad(3, texture.getSubTexture(3));
	    ...
	    Quad side4 = new Quad(4, texture.getSubTexture(4));
	    ...
	    Quad bottom = new Quad(5, texture.getSubTexture(5));
